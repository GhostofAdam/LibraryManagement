...
QT_MOC_LITERAL(3, 25, 8), // "DataUser"
QT_MOC_LITERAL(4, 34, 4), // "user"
QT_MOC_LITERAL(5, 39, 11), // "Destruction"
QT_MOC_LITERAL(6, 51, 13), // "on_ok_clicked"
QT_MOC_LITERAL(7, 65, 23) // "on_pushButton_2_clicked"

    },
    "RegisterDialog\0Register\0\0DataUser\0"
    "user\0Destruction\0on_ok_clicked\0"
...
void RegisterDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->Register((*reinterpret_cast< DataUser(*)>(_a[1]))); break;
        ...
        {
            typedef void (RegisterDialog::*_t)(DataUser );
        ...
        }
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&RegisterDialog::Destruction)) {
                *result = 1;
                return;
            }
        }
...
// SIGNAL 0
void RegisterDialog::Register(DataUser _t1)
{
...
// SIGNAL 1
void RegisterDialog::Destruction()
{
